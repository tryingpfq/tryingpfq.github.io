...
| **0423** | 1:  聊天功能基本模型                                         |
| **0424** | 1:  观察者模式。 2: 了解webSocket协议。                      |
| **0425** | 1: 看《高可用可伸缩微服务架构》。<br>2: spring boot 自动配置 |
...
| **0430** | 1:  @Configuratino 和 @bean 注解 [源码分析](https://www.cnblogs.com/ashleyboy/p/9667485.html) |
...
| **0502**  |                                                              |
| **0503**  |                                                              |
| **0504**  | 1: TCP 拆包粘包问题 Netty 的解决方案，对于Netty有本身自己的解决方案，可开箱即用，但对于复杂的业务来说，可能不过，我们可以自定义协议。<br>2: Netty 的入栈和出栈。 |
| **0505**  | 1: Lambda。<br>2: 类加载                                     |
| **0506**  | 1: 热更                                                      |
| **0507**  | 1:  延迟队列，订到支付超时如何处理。<br>2: Spring IOC。      |
| **0508**  | 1: fastjson  和 枚举一些问题(序列化和反序列化，持久化映射问题) |
| **0509**  | 1: 枚举                                                      |
| **0510**  |                                                              |
| **0511*** |                                                              |
| **0512**  | 1: Netty启动过程                                             |
...
|          |                                    |
|          |                                    |
| **0630*  |1：大部分时间在工作，这个月学习上只看了下重构这本书|
...
| **0709**  |                                        |
| **0710**  |                                        |
| **0711**  | 1：看《Effective Java》                |
| **0712**  | 1：看《Effective Java》Lambda 和Stream |
| **0713**  |                                        |
| **0714**  | 1：两道算法题。2：元空间OOM问题        |
| **0715**  | 1：两道算法题。                        |
| **0716**  | 1：算法，关于图                        |
| **0717**  |                                        |
| **0718**  |                                        |
